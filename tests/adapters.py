...
def run_embedding(
    ...
    from cs336_basics.layers.embedidng import embedding
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.func.saver import save_checkpoint
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return bpe_train(input_path, vocab_size, special_tokens)
